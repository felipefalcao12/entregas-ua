...
let dadosSmartwatch = new Produto("Mouse Storm Elite", 225.00, "Mouse Gamer Redragon Storm Elite Ultra Leve, Ergonômico e com Sensor Pixart 3389", "https://down-br.img.susercontent.com/file/br-11134207-7r98s-lmaislt969fb3d", true, 4.80, ["DPI mínimo: 100", "DPI máximo: 16000","Peso: 85 gr"], ["gamer", "mouse", "eletronicos"], 15);

let dadosSmartphone = new Produto("Notebook Acer Nitro 5", 5299.00, "Notebook Acer Nitro 5 AN515-58-54UH Ci5 12ª Gen Windows 11 Home 8GB 512GB RTX 3050 15.6” Full HD ", "https://m.media-amazon.com/images/I/71R+dGPqtrL._AC_UF1000,1000_QL80_DpWeblab_.jpg", true, 4.80, ["Tela de 15.6 polegadas","Full HD","RTX 3050"],["tecnologia","notebook","gamer"], 12)

let dadosNotebook = new Produto("Monitor Gamer Odyssey G30", 909.00 , "Monitor Gamer Odyssey G30, 24 Polegadas, 144hz, Tempo de resposta de 1ms, Ajuste de Altura, Cor: Preta","https://m.media-amazon.com/images/I/61rd8zerEqL._AC_UF894,1000_QL80_.jpg", true, 4.90, ["Painel VA","Resolução FHD","Conexões: HDMI e Display Port", "24 Polegadas"],["tecnologia","monitor","gamer","samsung"], 17)
...
let dadosMonitor = new Produto("Teclado Mecânico Husky", 259.00, "Teclado Mecânico Gamer Husky Gaming Blizzard, 60%, RGB, Switch Gateron Red, ABNT2, Branco - HGMO001", "https://images.kabum.com.br/produtos/fotos/114587/teclado-mecanico-gamer-husky-blizzard-rgb-switch-gateron-red-abnt2-branco-tc-hbl-br_1619467058_gg.jpg", true, 4.82, ["Switch Gateron Red", "FHD 1080p", "60%", "RGB", "Branco"], ["tecnologia", "teclado mecânico", "teclado 60%"], 10)
    
let listaDeProdutos = [dadosSmartwatch, dadosSmartphone, dadosHeadset, dadosNotebook, dadosMonitor];

function gerarCard(produtoObjeto){
    return `
    <div class="card">
